/**Computing interest, function takes amount (principal), interest rate (rate)
 * and year from local time then produces an html output */
...
//Updating value next to the slider
function updateRate()
{
